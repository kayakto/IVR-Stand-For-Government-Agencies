...
import { setStateItem, getStateItem, clearStorage } from './scripts/localstorage'
        ...
        offers.length ? (
          <div className="service-list flex">
            {offers.map(post => 
              ...
              ) : (<Post key ={post.id} data={post} childCount={post.children.length} childId={post.children[0]}/>))
             }
          </div>
        ) :
          (
